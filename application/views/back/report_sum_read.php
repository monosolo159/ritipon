  ...
  <div class="col-lg-12 col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h2><i class="fa fa-flag-o red"></i><strong>หนังสือที่ถูกอ่าน</strong>
      ...
      <div class="panel-body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="body">
              <?php echo form_open('/Admin/reportSumRead'); ?>
                 ...
                 <tbody>
                    ...
                    <?php foreach ($bookList as $bkey): ?>
                      <tr onclick="window.location.href = '<?php echo site_url('Admin/bookView/'.$bkey['book_id']) ?>';">
                         ...
                         <td><?php echo $bkey['book_all_read'] ?></td>
